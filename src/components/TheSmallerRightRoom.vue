...
<template>
  ...
  >
    ...
    ></a-entity>
    <a-entity
      geometry="primitive: plane; height: 1.2; width: 0.3"
      position="1.40 0.02 0"
      rotation="-90 0 0"
      data-role="nav-mesh"
      material="color: blue"
      visible="false"
    ...
    <a-entity
      geometry="primitive: plane; height: 0.65; width: 1.2"
      position="0.9 2.70 1.5"
      rotation="0 180 0"
      data-role="nav-mesh"
      material="src: #long-seamless-wall; repeat: 3 1"
      visible="true"
    ></a-entity>
    <a-entity
