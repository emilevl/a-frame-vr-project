...
<template>
  ...
  >
    <a-assets @loaded="allAssetsLoaded = true">
      ...
      <a-asset-item
        id="elevator"
        src="assets/elevator_-_low_poly_animated.glb"
      ></a-asset-item>
      ...
      <a-asset-item
        id="poster-wall"
        src="assets/russian_poster_1.glb"
      ></a-asset-item>
      ...
      <a-asset-item
        ...
        src="assets/Door_Opening_Closing.mp3"
        preload="auto"
      ></a-asset-item>
      <a-asset-item
        id="sound-elevator"
        response-type="arraybuffer"
        src="assets/Sliding_Glass_Door_Closing.mp3"
        preload="auto"
      ></a-asset-item>
      <a-asset-item
        id="sound-ambient-music"
        response-type="arraybuffer"
        src="assets/Devoid_ELPHNT.mp3"
        preload="auto"
      ></a-asset-item>
      <a-asset-item
        id="sound-ticking-clock"
        response-type="arraybuffer"
        src="assets/clock_ticking.mp3"
        preload="auto"
      ></a-asset-item>
    ...
    <a-entity
      light="color: #C5C5C5; type: ambient; intensity: 0.5"
      position="-1 1 -10"
    ></a-entity>
